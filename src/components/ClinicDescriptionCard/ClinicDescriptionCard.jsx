  ...
  return (
    <Row className="przychodnia-desc">
      <Col className="przychodnia-description ms-5">
        ...
        <h4>
          Nasz doświadczony zespół lekarzy jest gotowy, by zadbać o Ciebie i
          Twoją rodzinę. Zapraszamy do skorzystania z naszych usług medycznych
          już dziś!{" "}
        </h4>
        <h4>
          Oferujemy kompleksową opiekę medyczną dla całej rodziny, w tym:{" "}
        </h4>
        <ul className="ps-3">
          <li>
            <h4>Poradnictwo zdrowotne</h4>
          </li>
          <li>
            <h4>Badania profilaktyczne</h4>
          </li>
          <li>
            <h4>Konsultacje lekarskie</h4>
          </li>
          <li>
            <h4>Leczenie chorób przewlekłych</h4>
          </li>
          <li>
            <h4>Rehabilitację</h4>
          </li>
